...
export default PostTeaserSkeleton = props => {
  color = "green";
  return (
    <View style={{ paddingHorizontal: Layouts.PAD_HORZ, paddingVertical: Layouts.PAD_VERT }}>
      <Placeholder
        Animation={Fade}
        Left={ props => (
          <PlaceholderMedia
      ...
      <Placeholder
        ...
        style={{marginTop: 18}}
        >
        <PlaceholderMedia height={250} width={250} style={{borderRadius: Mixins.scaleSize(20), height: 250, width: "100%"}}/>
      </Placeholder>
    </View>
  );
};
